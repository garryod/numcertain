...
.. _GitHub: https://github.com/garryod/numcertain/issues
...
To get the source source code and run the unit tests, run::
    ...
    $ git clone git://github.com/garryod/numcertain.git
    $ cd numcertain
    $ pip install -e .[dev]
    $ pytest
...
.. _release: https://github.com/garryod/numcertain/releases
