...
.. _GitHub: https://github.com/dls-controls/numcertain/issues
...
To get the source source code and run the unit tests, run::
    ...
    $ git clone git://github.com/dls-controls/numcertain.git
    $ cd numcertain
    $ pipenv install --dev
    $ pipenv run tests
...
.. _release: https://github.com/dls-controls/numcertain/releases
